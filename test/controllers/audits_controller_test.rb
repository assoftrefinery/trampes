...
class AuditsControllerTest < ActionController::TestCase
  ...
  test "should create audit" do
    assert_difference('Audit.count') do
      post :create, audit: { dataaudit: @audit.dataaudit, observacions: @audit.observacions }
    end
  ...
  test "should update audit" do
    patch :update, id: @audit, audit: { dataaudit: @audit.dataaudit, observacions: @audit.observacions }
    assert_redirected_to audit_path(assigns(:audit))
  end
